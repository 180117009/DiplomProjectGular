                                                                ...
                                                                <div class="table-responsive">
                                                                    <table id="data-table"
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                            $uid = $_SESSION['obcsuid'];
                                                                            $sql="SELECT * from tbllecture where tbllecture.StudentID=:uid";
                                                                            $query = $dbh -> prepare($sql);
                                                                            $query->bindParam(':uid', $uid, PDO::PARAM_STR);
                                                                            $query->execute();
                                                                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                                                                            ...
                                                                            <tr>
                                                                               ...
                                                                               <td><?php  echo htmlentities($row->NameLecture);?></td>
                                                                               <td><a class="link-primary" href="http://gular.kz/teacher/lecture/<?php echo $row->FilePDF; ?>" target="_blank">Lecture</a></td>
                                                                               <td><a class="link-primary" href="<?php  echo htmlentities($row->VideoLink);?>" target="_blank">VideoLink</a></td>
                                                                            </tr>
                                                                            <?php }} ?>
                                                                        </tbody>
                                                                    </table>
