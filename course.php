                                                        ...
                                                        <div class="tabs-menu1">
                                                            ...
                                                            <ul class="nav panel-tabs product-sale">
                                                                <li><a href="#tab5" class="active"
                                                                        data-bs-toggle="tab">All test</a></li>
                                                                <li><a href="#tab6" data-bs-toggle="tab"
                                                                        class="text-dark">Current</a></li>
                                                                <li><a href="#tab7" data-bs-toggle="tab"
                                                                        class="text-dark">Past</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="table-responsive">
                                                                  <table id="data-table"
                                                                        ...
                                                                        <tbody>
                                                                          <?php
                                                                          $uid = $_SESSION['obcsuid'];
                                                                          $sql = "SELECT `tbltopic`.`Name`,`tbl_t_s`.`ID`, `tbl_t_s`.`StudentID` FROM `tbltopic` INNER JOIN `tbl_t_s` ON `tbltopic`.`ID`=`tbl_t_s`.`topicID` where tbl_t_s.StudentID=:uid "; 
                                                                          $query = $dbh->prepare($sql);
                                                                          $query->bindParam(':uid', $uid, PDO::PARAM_STR);
                                                                          $query->execute();
                                                                          $results = $query->fetchAll(PDO::FETCH_OBJ);
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table
                                                                        ...
                                                                        <tbody>
                                                                          <?php
                                                                          $uid = $_SESSION['obcsuid'];
                                                                          $sql = "SELECT `tbltest`.`NameTest`, `tbltopic`.`ID`,`tbltopic`.`Name` FROM `tbltest`INNER JOIN `tbltopic` on `tbltest`.`topicID`=`tbltopic`.`ID`;"; 
                                                                          $query = $dbh->prepare($sql);
                                                                          $query->bindParam(':uid', $uid, PDO::PARAM_STR);
                                                                          $query->execute();
                                                                          $results = $query->fetchAll(PDO::FETCH_OBJ);
                                                                        ...
                                                                        <tr>
                                                                          <td><?php echo htmlentities($row->ID); ?></td>
                                                                          <td><?php echo htmlentities($row->Name); ?></td>
                                                                           <td><?php echo htmlentities($row->NameTest); ?></td>
                                                                          <td>
                                                                            <div class="g-2">
