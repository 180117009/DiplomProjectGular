                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                               ...
                                                                               <td><?php  echo htmlentities($row->DataEnd);?></td>
                                                                                <td>
                                                                                    <div class="g-2">
                                                                                        <a href="view-tasks.php?viewid=<?php echo htmlentities ($row->ID);?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <?php }} ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    ...
                    <form action="view-task.php">
                      <div class="mb-3">
                        <label for="recipient-name" class="col-form-label">File:</label>
                        <input type="file" class="form-control" id="recipient-name">
                        <input type="text" class="form-control" id="recipient-name" value="<?php echo htmlentities($row->NameTask); ?>">
                      </div>
                    </form>
                    
                  </div>
                <div class="modal-footer">
                    <button class="btn ripple btn-success" type="button">Upload</button>
