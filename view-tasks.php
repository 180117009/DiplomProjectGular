                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            ...
                            <div>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="javascript:void(0)">Site home</a></li>
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title mb-0">Courses I am taking</h3>
                                    </div>
                                                        ...
                                                        <div class="tabs-menu1">
                                                            ...
                                                            <ul class="nav panel-tabs product-sale">
                                                                <li><a href="#tab5" class="active"
                                                                        data-bs-toggle="tab">All courses</a></li>
                                                                    ...
                                                                    <table id="data-table"
                                                                        ...
                                                                        <thead>
                                                                           <tr>
                                                                               ...
                                                                               <th>File</th>
                                                                               <th>Pass up to</th>
                                                                               <th class="bg-transparent border-bottom-0" style="width: 5%;">Upload task</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <?php
                                                                            $uid = $_SESSION['obcsuid'];
                                                                            $sql="SELECT * from tbltask where tbltask.StudentID=:uid";
                                                                            $query = $dbh -> prepare($sql);
                                                                            $query->bindParam(':uid', $uid, PDO::PARAM_STR);
                                                                            $query->execute();
                                                                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                                                                            ...
                                                                            <tr>
                                                                               ...
                                                                               <td><?php  echo htmlentities($row->NameTask);?></td>
                                                                               <td><a class="link-primary" href="http://gular.kz/teacher/task/<?php echo $row->FilePDF; ?>" target="_blank">Task</a></td>
                                                                               <td><?php  echo htmlentities($row->DataEnd);?></td>
                                                                                <td>
                                                                                    <div class="g-2">
                                                                                        <button type="button" class="btn btn-green me-3  mt-2" data-bs-toggle="modal" data-bs-target="#input-modal" data-bs-whatever="@mdo">Upload task</button>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                            <?php }} ?>
...
<div class="modal fade" id="input-modal">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Upload task</h6>
             ...
             $sql="SELECT tbltask.*,tblstudent.Name,tblstudent.LastName,tblstudent.User,tblstudent.Email from  tbltask join  tblstudent on tbltask.StudentID=tblstudent.ID where tbltask.ID=:vid";
$query = $dbh -> prepare($sql);
$query-> bindParam(':vid', $vid, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
{               ?>
                ...
                <div class="modal-footer">
                    <button class="btn ripple btn-success" type="submit" name="submit">Upload</button>
