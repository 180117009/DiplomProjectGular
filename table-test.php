                                                                    ...
                                                                    <table id="data-table"
                                                                        ...
                                                                        <thead>
                                                                           <tr>
                                                                               ...
                                                                               <th>Test name</th>
                                                                               <th>Pass up to</th>
                                                                               <th class="bg-transparent border-bottom-0" style="width: 5%;">Start test</th>
                                                                            </tr>
                                                                        </thead>
                                                                        <tbody>
                                                                            <?php
                                                                            $uid = $_SESSION['obcsuid'];
                                                                            $sql="SELECT * from tbl_t_s where tbl_t_s.StudentID=:uid";
                                                                            $query = $dbh -> prepare($sql);
                                                                            $query->bindParam(':uid', $uid, PDO::PARAM_STR);
                                                                            $query->execute();
                                                                            $results=$query->fetchAll(PDO::FETCH_OBJ);
                                                                            ...
                                                                            <tr>
                                                                               ...
                                                                               <td><?php  echo htmlentities($row->TestID);?></td>
                                                                               <td><?php  echo htmlentities($row->Pass);?></td>
                                                                                <td>
                                                                                    <div class="g-2">
                                                                                        <a href="test.php?viewid=<?php echo htmlentities ($row->ID);?>" class="btn text-primary btn-sm"
